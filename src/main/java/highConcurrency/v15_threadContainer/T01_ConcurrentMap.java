...
public class T01_ConcurrentMap {
    ...
    public static void main(String[] args) {
        ...
        // Map<String, String> map = new ConcurrentHashMap<>(); // 449，加的是分段锁，将容器分为16段，每段都有一个锁 segment; 1.8以后 使用 Node + synchronized+CAS
        ...
        System.out.println("map size : " + map.size()); //10000，为什么？如果选择 hashmap，size > 10000 为什么？
    }
